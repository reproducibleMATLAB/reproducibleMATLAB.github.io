...
Please see the [source code](https://github.com/reproducibleMATLAB/reproducibleMATLAB.github.io/){target='_blank'} to see that anonymity settings are enabled in the quarto config  (`_quarto.yml`) - which is used to generate the site.
